    ...
    <div class = "main">
        <div class = "el-col el-col-24 el-col-xs-24 el-col-sm-2" style = "height:100%">
            <el-menu :default-active="route" class="el-menu-vertical-demo" style = "background:#fff;height:calc(100% - 10px);padding-top:10px">
                <el-menu-item index="1"><router-link to = "/vehicleAuditSide/vehicleNoAudited"><span>待审核车辆</span></router-link></el-menu-item>
                <el-menu-item index="2"><router-link to = "/vehicleAuditSide/vehicleIsAudited"><span>已审核车辆</span></router-link></el-menu-item>
