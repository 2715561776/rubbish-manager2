//package com.richeninfo.rubbish.entity.config;
//
...
//import com.richeninfo.rubbish.entity.config.datasource.DataSourceConfiguration;
...
//		page.setDialectType(dbType.name());
//		return page;
//	}
//	/**
...
//		globalConfig.setDbType(dbType.name());//数据库类型
//		//执行主键规则（针对Oracle的SEQ单独设置）
//		globalConfig.setKeyGenerator(new OracleKeyGenerator());
//		// ID 策略 AUTO->`0`("数据库ID自增") INPUT->`1`(用户输入ID") ID_WORKER->`2`("全局唯一ID") UUID->`3`("全局唯一ID")
//		//OracleKeyGenerator 设置之后 此处不用设置
