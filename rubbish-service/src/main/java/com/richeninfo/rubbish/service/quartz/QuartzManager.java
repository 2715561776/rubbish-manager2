...
public class QuartzManager {
     ...
     */
    public static void addJob(Scheduler sched, String jobName, @SuppressWarnings("rawtypes") Class cls, String time, JobDataMap jobDataMap) {
        try {
    ...
    public static void modifyJobTime(Scheduler sched, String jobName, String time, JobDataMap jobDataMap) {
        try {
            ...
            if (!oldTime.equalsIgnoreCase(time)) {
                ...
                addJob(sched, jobName, objJobClass, time,jobDataMap);
            }
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
